...
function drawMapFromPlanet(planet) {
  ...
  var map = "<div class=\"map mx-auto\">";

  for (var y = 0; y < planet.coordinates[1]; y++) {
    map += "<div class=\"map-".concat(x + 1, "\">");

    for (var _x = 0; _x < planet.coordinates[0]; _x++) {
      map += "<div class=\"way (".concat(_x + 1, ",").concat(y + 1, ")\">(").concat(_x + 1, ",").concat(y + 1, ")</div>");
    }
...
function drawObstacles(planet) {
  planet.obstacles_coordinates.forEach(function (element) {
...
document.getElementById('landing').addEventListener("click", function (event) {
  ...
  var data = {
    ...
    'planet_name': "Mars",
    'position': [document.getElementById('x').value, document.getElementById('y').value],
